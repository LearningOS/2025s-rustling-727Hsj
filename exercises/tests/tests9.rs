...
unsafe extern "Rust" {
    unsafe fn my_demo_function(a: u32) -> u32;
    unsafe fn my_demo_function_alias(a: u32) -> u32;
   }
   ...
   mod tests {
       ...
       fn test_success() {
           ...
           // Rust function.
           unsafe {
               assert_eq!(Foo::my_demo_function(123), 123);
               assert_eq!(Foo::my_demo_function_alias(456), 456);
           }
       }
   }
